...
namespace 恒温测试机.Utils
{
    ...
    public class DataTableUtils
    {
        ...
        /// <returns></returns>
        public static DataTable SubDataTable(DataTable sourceTable,int startIndex,int endIndex)
        {
            DataTable result = sourceTable.Clone();
            var query = sourceTable.AsEnumerable().Skip(startIndex).Take(endIndex - startIndex);
